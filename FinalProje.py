...
def display():
    ...
    glLoadIdentity()
    gluPerspective(60.0, 8.0 / 4.0, 1, 40)
    glMatrixMode(GL_MODELVIEW)
    glLoadIdentity()
    gluLookAt(camera.xPos, camera.yPos, camera.zPos, camera.xPos + camera.directionX, camera.yPos-0.7 + camera.directionY,
    ...
    glTexCoord2f(0.0, 1.0), glVertex3f(-30.0, 0.0, 30.0)
    ...
    glColor3f(1, 1, 1)
    glBegin(GL_QUADS)
    glTexCoord2f(0.0, 0.0),glVertex3f(-30.0, 0, -30.0)
    glTexCoord2f(0.0, 1.0),glVertex3f(-30.0, 0, 30.0)
    glTexCoord2f(1.0, 1.0),glVertex3f(-30.0, 30.0, 30.0)
