...
def display():
    ...
    glLoadIdentity()
    gluPerspective(60.0, 8.0 / 4.0, 1, 120)
    ...
    glBegin(GL_QUADS)
    glTexCoord2f(0.0, 0.0),glVertex3f(-80.0, 0.0, -80.0)
    glTexCoord2f(0.0, 1.0),glVertex3f(-80, 30, -80.0)
    ...
    glColor3f(1, 1, 1)
    glBegin(GL_QUADS)
    glTexCoord2f(0.0, 0.0),glVertex3f(-80.0, 0, -80.0)
    glTexCoord2f(0.0, 1.0),glVertex3f(-80.0, 0, 80.0)
    glTexCoord2f(1.0, 1.0),glVertex3f(-80.0, 30.0, 80.0)
